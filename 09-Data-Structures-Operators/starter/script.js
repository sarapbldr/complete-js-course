...
// Iterables: arrays, ring, maps, sets. NOT objects
const str = 'Jonas';
const letters = [...str, ' ', 'S.'];
console.log(letters);
...
//Objects
const newRestaurant = { foundedIn: 1978, ...restaurant, founder: 'Giseppe' };
...
console.log(
  `You have selected ${starter}🍞 and ${mainCourse}🍕. Enjoy your food!`
);
